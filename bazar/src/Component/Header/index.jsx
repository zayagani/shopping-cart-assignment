...
const Header = (_addToCartReducer) => {
  ...
  return (
    <React.Fragment>
      ...
      {isCartPopUp &&
        <CartPage handleCartOpen={CartPopUp} />
      }
      <Outlet />
    </React.Fragment>
  );
